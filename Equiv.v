...
Proof.
  ...
  Case "<-".
    inversion H; subst.
    SCase "BNot b evaluates to true"; 
      apply E_IfFalse. simpl in H5. apply negb_true_iff in H5. apply H5. apply H6.
    SCase "b evaluates to false".
      apply E_IfTrue. simpl in H5. apply negb_false_iff in H5. apply H5. apply H6.
Qed.
...
Proof. 
  ...
  Case "<-".
    apply WHILE_true_nonterm in H. inversion H. unfold bequiv. reflexivity.
Qed.
(** [] *)
