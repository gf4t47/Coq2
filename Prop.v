...
Proof.
   ...
   Case "m<>0". simpl. apply b_sum. apply H. apply IHm'.
Qed.
(** [] *)
...
Proof.
   intros.
   induction n.
   Case "n=0". simpl. apply g_plus3. apply g_plus5. apply g_plus5. apply g_0.
   Case "n<>0". apply g_plus3. apply g_plus5. apply g_plus5. apply H.
Qed.
