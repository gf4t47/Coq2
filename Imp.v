...
Proof.
  ...
  Case "x2 = x1". subst x1. rewrite update_eq. rewrite update_eq. reflexivity.
  Case "x2 <> x1". repeat rewrite update_neq. reflexivity. apply n. apply n. apply n.
Qed.
(** [] *)
...
Proof.
  ...
  Case "x2 = x1". subst x1. rewrite update_eq. rewrite H. reflexivity.
  Case "x2 <> x1". rewrite update_neq. reflexivity. apply n.
Qed.
(** [] *)
...
Proof.
  ...
  Case "First Cmd". apply E_Ass. reflexivity.
  Case "Second, Third Cmd".
    apply E_Seq with (update (update empty_state X 0) Y 1).
    SCase "Seoncd cmd". apply E_Ass. reflexivity.
    SCase "Third cmd". apply E_Ass. reflexivity.
Qed.
(** [] *)
